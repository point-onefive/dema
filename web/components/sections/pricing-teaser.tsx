      ...
      <Container>
        <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-[1fr_1fr] lg:gap-16">
          <div>
            ...
            <Reveal delay={0.14}>
              <p className="mt-5 max-w-[440px] text-[16px] leading-[1.6] text-[color:var(--color-ink-3)]">
          ...
          <Reveal delay={0.1}>
            <div className="rounded-3xl border border-[color:var(--color-line)] bg-[color:var(--color-surface)] p-7 shadow-[var(--shadow-md)] sm:p-9">
              ...
              <RevealGroup className="space-y-3" stagger={0.06}>
                {inclusions.map((line) => (
                  <RevealItem key={line}>
                    <div className="flex items-start gap-2.5 text-[14.5px] text-[color:var(--color-ink-2)]">
